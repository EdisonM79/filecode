...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 项目管理 <span class="c-gray en">&gt;</span> 所有项目 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="pd-20">
	<div class="row col-10">
	   <label style="color:orange;" class="form-label col-10">
       默认错误页面(当找不到上面mappings中指定的异常对应视图时，使用本默认配置)
      </label>
	</div> 
	<div class="row col-10">
	   <label style="color:red;" class="form-label col-10">
       请通知维护人员进行调试维护
      </label>
	</div> 
</div>
