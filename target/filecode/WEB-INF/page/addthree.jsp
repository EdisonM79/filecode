...
<div class="page-container">
	<form action="${pageContext.request.contextPath}/admin/three/save" method="post" class="form form-horizontal" id="form-product-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="threeName" name="threeName"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>版本号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="threeVersion" name="threeVersion"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>发布年份：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
...
$(document).ready(function ()
{
	$("#addButton").click(function( )
	{
         ...
         if(threeName==null||threeName==""){
             layer.alert("请填写三级文件名称！");
             return false;
         }
         ...
         $.ajax({
             ...
             type: "POST",
             dataType: "json",
             url:"${pageContext.request.contextPath}/admin/three/save",
