...
public class InterfaceConstants {
	...
	/** 农场管理-农场报表-传感器对比分析详情 */
	public static final String FARM_SENSOR_COMPARATIVE_ANALYSIS_DETIL = SERVER_ADDRESS + "/sensor/querySensorContrastiveAnalysisView";
	/** 农场管理-农场报表-流程控制记录表 */
	public static final String FARM_FLOW_CTRL_RECORD_LIST = SERVER_ADDRESS + "/flowCtrlRecord/queryForFlowCtrlRecordList";
	/** 农场管理-农场报表-流程控制详情 */
	...
	/** 农场管理-农场报表-触发控制记录表 */
	public static final String FARM_TRIGGER_CTRL_RECORD_LIST = SERVER_ADDRESS + "/triggerRecord/queryForTriggerRecordList";
	/** 农场管理-农场报表-触发控制记录表删除 */
	...
	/** 农场管理-农场报表-策略控制记录表 */
	public static final String FARM_REPORT_STRATEGY_OPERATE_LIST = SERVER_ADDRESS + "/strategyCtlRecord/queryStrategyCtlRecordList";
	/** 农场管理-农场报表-策略控制记录删除 */
	public static final String FARM_REPORT_STRATEGY_OPERATE_DELETE = SERVER_ADDRESS + "/strategyCtlRecord/delStrategyCtlRecord";
	/** 农场管理-农场报表-策略控制记录详情 */
	public static final String FARM_REPORT_STRATEGY_OPERATE_DETIL = SERVER_ADDRESS + "/strategyCtlRecord/queryStrategyCtlRecordInfo";
	/** 农场管理-农场报表-单点操作记录表 */
	public static final String FARM_REPORT_SINGLE_OPERATE_LIST = SERVER_ADDRESS + "/sensorCtlRecord/querySensorCtlRecordList";
	/** 农场管理-农场报表-单点操作记录删除 */
	public static final String FARM_REPORT_SINGLE_OPERATE_DELETE = SERVER_ADDRESS + "/sensorCtlRecord/delSensorCtlRecord";
	/** 返回单个农场信息 */
	public static final String FARM_INFO = SERVER_ADDRESS + "/farm/queryOneFarmInfoById";
	/** 农场管理-农场报表-设备状态记录列表 */
	public static final String FARM_REPORT_QUERY_DEVICE_STATUS_LIST = SERVER_ADDRESS + "/deviceStateRecord/queryDeviceStateForFarmReport";
	/** 农场管理-农场报表-删除设备状态记录 */
	public static final String FARM_REPORT_DELETE_DEVICE_STATUS_RECORD = SERVER_ADDRESS + "/deviceStateRecord/delDeviceStateRecord";
	/** 农场管理-开关型传感器类型列表 */
	...
	/** 运维日志-添加单点操作记录 */
	public static final String LOG_OPERATE_REPORT_ADD_SINGLE_RECORD = SERVER_ADDRESS + "/sensorCtlRecord/addSensorCtrlRecord";
	...
	/** 设备监控-(查询） 修改阀控器 */
	public static final String DEVICE_QUERY_AND_MODIFY_VALVECONTROL = SERVER_ADDRESS + "/device/queryValveControlDevice";
	/** 设备监控-虚拟设备列表（分页） */
	 ...
	 */
	/** 分类管理-大分类列表 */
	public static final String SENSOR_TYPES_COLL_QUERY_SENSOR_TYPES_COLL = SERVER_ADDRESS + "/sensorTypesColl/querySensorTypesColl";
	/** 分类管理-添加大分类 */
	public static final String SENSOR_TYPES_COLL_ADD_SENSOR_TYPES_COLL = SERVER_ADDRESS + "/sensorTypesColl/addSensorTypesColl";
	/** 分类管理-删除大分类 */
	public static final String SENSOR_TYPES_COLL_DEL_SENSOR_TYPES_COLL = SERVER_ADDRESS + "/sensorTypesColl/delSensorTypesColl";
	/** 分类管理-编辑大分类 */
	public static final String SENSOR_TYPES_COLL_UPDATE_SENSOR_TYPES_COLL = SERVER_ADDRESS + "/sensorTypesColl/updateSensorTypesColl";
	/** 分类管理-选择大分类 */
	public static final String SENSOR_TYPES_COLL_QUERY_SENSOR_TYPES_COLL_FOR_NAME_ANDID = SERVER_ADDRESS + "/sensorTypesColl/querySensorTypesCollForNameAndId";
	/** 分类管理-小分类列表 */
	public static final String SENSOR_TYPE_QUERY_SENSOR_TYPE_LIST = SERVER_ADDRESS + "/sensorType/queryForSensorTypeList";
	/** 分类管理-小分类详情 */
	...
	/** 子流程控制列表 */
	public static final String FLOW_TASK_QUERY_FLOW_TASK_BY_FLOW_ID_FOR_DATE = SERVER_ADDRESS + "/flowTask/queryFlowTaskByFlowIdForDate";
	/** 子流程详情 */
