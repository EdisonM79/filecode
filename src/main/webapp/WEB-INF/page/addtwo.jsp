...
<div class="page-container">
	<form action="${pageContext.request.contextPath}/admin/two/save" method="post" class="form form-horizontal" id="form-product-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="文件名称" id="fileName" name="fileName"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>版本号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="版本号" id="version" name="version"/>
			</div>
		</div>
		<div class="row cl">
...
$(document).ready(function ()
{
	$("#addButton").click(function( )
	{
         ...
         $.ajax({
             ...
             type: "POST",
             dataType: "json",
             url:"${pageContext.request.contextPath}/admin/two/save",
