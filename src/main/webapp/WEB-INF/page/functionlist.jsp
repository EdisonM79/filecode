...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 职能管理
...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a class="btn btn-primary radius" onclick="employee_add('编码录入','${pageContext.request.contextPath}/admin/function/add')" href="javascript:;">
				<i class="Hui-iconfont">&#xe600;</i> 新增职能
			</a>
		</span> 
	...
	<div class="mt-20 input-father">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${functions}" var="function">  
				<tr class="text-c">
					<input type="hidden" value="${function.functionId}" name="userId">
