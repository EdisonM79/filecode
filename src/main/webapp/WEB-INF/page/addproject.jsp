...
<div class="page-container">
	<form action="${pageContext.request.contextPath}/admin/project/save" method="post" class="form form-horizontal" id="form-product-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="projectCode" name="projectCode"/>
			</div>
		</div>
		<div class="row cl">
...
$(document).ready(function ()
{
	$("#addButton").click(function( )
	{
         ...
         $.ajax({
             ...
             type: "POST",
             dataType: "json",
             url:"${pageContext.request.contextPath}/admin/project/save",
