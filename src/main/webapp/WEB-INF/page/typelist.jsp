...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 分类管理
...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a class="btn btn-primary radius" onclick="employee_add('分类录入','${pageContext.request.contextPath}/admin/type/add')" href="javascript:;">
	...
	<div class="mt-20 input-father">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${types}" var="type">  
				<tr class="text-c">
					<input type="hidden" value="${type.typeId}" name="userId">
					<td>${type.typeId}</td>
					<td>${type.typeName}</td>
					<td>${type.typeCode}</td>
